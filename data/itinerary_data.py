...
itinerary = {
    ...
    "2024-12-16": {
        ...
        "morning": {
            ...
            "description": 
                "景點:\n\n" +
                    "➖ 清澄庭園: 清澄庭園是東京都指定名勝的日式庭園，擁有池泉回遊式設計，園內種植了黑松、紫杜鵑、繡球花、山櫻花等植物。\n\n" +
                    "➖ 品嚐特色咖啡： 清澄白河以咖啡文化聞名，早晨可前往以下咖啡店享用早餐\n\n" +
                        "➖➖ Blue Bottle Coffee 清澄白河店： 這是Blue Bottle在日本的首家店，提供新鮮烘焙的咖啡和限定甜點。\n\n" +
                        "➖➖ B²（B squared）： 這是一間結合咖啡店與烘焙坊的店家，提供使用天然酵母製作的現烤麵包和精心調製的咖啡。\n\n" +
                    "➖ 東京都現代美術館: \n\n" +
    ...
    "2024-12-17": {
        ...
        "morning_1": {
            ...
            "end_time": "09:00",
            "duration": "2 小時",
            "transport": "交通：飯店 ➖ 京急蒲田 京急本線 12分 ➖ 東銀座 ➡➡ 築地市場",
            "description": 
                "美食: \n\n" +
    ...
    "2024-12-19": {
        "title": "石岡懷舊與返程時光：歷史老街與回家的步伐",
        "morning": {
            "attraction": "石岡",
            "start_time": "10:00",
            "end_time": "12:00",
            "duration": "2 小時",
            "transport": "飯店 ➖ 常磐線勝田 15分 ➖ 石岡",
            "description": 
                "✔️ 退房手續，確保所有行李已打包完畢。\n\n" +
                "景點:\n\n" +
